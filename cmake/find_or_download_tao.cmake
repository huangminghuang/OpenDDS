...
function(find_sanitizer_package_in_dir ace_tao_dir)
  if (EXISTS "${ace_tao_dir}/externals/sanitizers-cmake/cmake/FindSanitizers.cmake")
    message("Found Sanitizer module")
    set(CMAKE_MODULE_PATH "${ace_tao_dir}/externals/sanitizers-cmake/cmake" ${CMAKE_MODULE_PATH})
...
if (NOT TARGET TAO)
  if (NOT TAO_DIR AND NOT ACE_TAO_SOURCE_DIR AND EXISTS ${PROJECT_SOURCE_DIR}/ACE_TAO/CMakeLists.txt)
    set(ACE_TAO_SOURCE_DIR ${PROJECT_SOURCE_DIR}/ACE_TAO)
  endif()

  if (ACE_TAO_SOURCE_DIR)
    ensure_valid_ace_tao_source_tree()
    set(ACE_TAO_BINARY_DIR ${CMAKE_CURRENT_BINARY_DIR}/ACE_TAO)
    find_sanitizer_package_in_dir(${ACE_TAO_SOURCE_DIR})
    ...
    if (NOT TAO_FOUND)
      ...
      find_sanitizer_package_in_dir(${ACE_TAO_SOURCE_DIR})
      include(ACE_TAO_for_DDS.cmake)
      add_subdirectory(${ACE_TAO_SOURCE_DIR} ${CMAKE_CURRENT_BINARY_DIR}/ACE_TAO)
    else(NOT TAO_FOUND)
      message("-- Found TAO: ${TAO_DIR} (found version \"${TAO_VERSION}\")")
      find_sanitizer_package_in_dir(${TAO_INCLUDE_DIR}/..)
    endif(NOT TAO_FOUND)
  endif(ACE_TAO_SOURCE_DIR)

else(NOT TARGET TAO)
  find_sanitizer_package_in_dir(${TAO_INCLUDE_DIR}/..)
  if (TAO_INCLUDE_DIR STREQUAL "${CMAKE_CURRENT_BINARY_DIR}/ACE_TAO-src/TAO")
    add_subdirectory(${CMAKE_CURRENT_BINARY_DIR}/ACE_TAO-src ${CMAKE_CURRENT_BINARY_DIR}/ACE_TAO)
  endif()
